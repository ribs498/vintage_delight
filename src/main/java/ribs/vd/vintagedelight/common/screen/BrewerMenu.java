...
public class BrewerMenu extends AbstractContainerMenu {
    public final BrewerBlockEntity blockEntity;
    ...
    public BrewerBlockEntity getBlockEntity() {
